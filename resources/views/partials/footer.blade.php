                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="ul-footer-widget">
                            ...
                            <ul class="ul-footer-widget-links">
                                ...
                                <li><a href="{{ route('events') }}" class="text-white">Events</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="ul-footer-widget">
                            ...
                            <ul class="ul-footer-widget-links">
                                <li><a href="{{ route('koje-originals') }}" class="text-white">Koje Originals</a></li>
                                <li><a href="{{ route('koje-essentials') }}" class="text-white">Koje Essentials</a></li>
                                <li><a href="{{ route('koje-production') }}" class="text-white">Koje Production</a></li>
                                <li><a href="{{ route('koje-initiative') }}" class="text-white">Koje Initiative</a></li>
                                <li><a href="{{ route('koje-vision-screen') }}" class="text-white">Koje Vision Screen</a></li>
                            </ul>
                        </div>
                    </div>
